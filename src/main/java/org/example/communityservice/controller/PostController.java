...
public class PostController {
    ...
    @GetMapping
    public ResponseEntity<CommonResponseDto<PostListCursorResponseDto>> showPostList(
    ...
    public ResponseEntity<CommonResponseDto<PostResponseDto>> createPost(
            @AuthenticationPrincipal Long userId,
            @Valid @RequestPart("content") PostRequestDto postRequestDto,
    ...
    @GetMapping("/{postId}")
    public ResponseEntity<CommonResponseDto<PostDetailResponseDto>> showPostDetail(
            @AuthenticationPrincipal Long userId,
    ...
    public ResponseEntity<CommonResponseDto<PostResponseDto>> updatePost(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long postId,
            @Valid @RequestPart("content") PostUpdateRequestDto postUpdateRequestDto,
    ...
    public ResponseEntity<CommonResponseDto<Void>> deletePost(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long postId){
    ...
    public ResponseEntity<CommonResponseDto<PostLikeCountResponseDto>> toggleLike(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long postId){
